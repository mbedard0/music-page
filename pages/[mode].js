...
const Post = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-center gap-2'>
      ...
      <button onClick={skip} className='btn btn-active btn-ghost'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-skip-forward" viewBox="0 0 16 16">
